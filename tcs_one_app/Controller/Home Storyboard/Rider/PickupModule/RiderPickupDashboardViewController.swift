//
//  RiderPickupDashboardViewController.swift
//  tcs_one_app
//
...
class RiderPickupDashboardViewController: BaseViewController {
    let constant = "Enter Pickup # or Account #"
...
extension RiderPickupDashboardViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.cnNumber.text = "Pickup Number"
        cell.sheetNumber.text = "Account Number"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let controller = self.storyboard?.instantiateViewController(withIdentifier: "RiderPickupUpdateListingViewController") as! RiderPickupUpdateListingViewController
        self.navigationController?.pushViewController(controller, animated: true)
    }
    
    @objc func googlePinTapped(sender: UIButton) {
        let storyboard = UIStoryboard(name: "RiderDelivery", bundle: nil)
        let controller = storyboard.instantiateViewController(withIdentifier: "RiderGoogleLocationViewController") as! RiderGoogleLocationViewController
        self.navigationController?.pushViewController(controller, animated: true)
    }
...
extension RiderPickupDashboardViewController: UITextFieldDelegate {
