...
static const CGFloat kDefaultOutlinedContainerStyleCornerRadius = (CGFloat)10.0;
...
- (void)setUpOutlineLineWidths {
  ...
  self.outlineLineWidths[@(MDCTextControlStateNormal)] = @(1.3);
  self.outlineLineWidths[@(MDCTextControlStateEditing)] = @(2);
  self.outlineLineWidths[@(MDCTextControlStateDisabled)] = @(1.3);
}
